...
<div class = "container content-panel row">
	...
	<ol class="breadcrumb">
	  ...
	  <div class="panel panel-default">
			<div class="panel-heading lead">Sales Orders List</div>
					...
					<table class="table table-striped table-hover">
						...
						foreach ($salesdata as $row){
							if($row->type==1){
						 	...
						 	echo"<td><button style='border:none;' data-toggle='modal' data-target='#view' name='delete_btn' data-id='".$row->oid."' class='btn-primary btn_circle btn_xl'><i class='glyphicon glyphicon-list'></i></button></td> " ;
						 	echo"<td><a href='".site_url('sales/Sales_controller/edit/'.$row->oid.'')."'><button style='border:none;' name='delete_btn' data-id='".$row->oid."' class='btn-warning btn_circle btn_xl update'><i class='glyphicon glyphicon-edit'></i></button></a></td> " ;
						 	echo"<td><button style='border:none;'  data-toggle='modal' data-target='#edit' name='delete_btn' data-id='".$row->oid."' class='btn-success btn_circle btn_xl'><i class='glyphicon glyphicon-ok'></i></button></td> " ;
