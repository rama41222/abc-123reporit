				...
				<li class="active">Sales</li>
					...
					<div class="col-sm-6">
						...
						<div class="col-sm-6">
							 ...
							 <div class="panel panel-default">
						      <div class="panel-heading lead">Reports</div>
						      <div class="panel-body lead">
						      <ul>
						      		<li><a>Sales Order Report</a></li>
						      		<li><a>Requisition Report</a></li>
						      		<br/>
